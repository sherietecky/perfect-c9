...
searchHistory.forEach((div) => {
  div.addEventListener("click", async () => {
    ...
    const result = await fetch(`/marketdata/${searchWord}`);
    let json = await result.json();
    console.log(json);
    ...
    market2.addEventListener("click", async () => {
      ...
      const result = await fetch(`/marketdata/${searchWord}/2`);
      let json = await result.json();
      console.log(json);
      for (let data of json) {
        console.log(data);
    ...
    market3.addEventListener("click", async () => {
      ...
      let searchWord = div.innerHTML;
      const result = await fetch(`/marketdata/${searchWord}/3`);
      let json = await result.json();
      console.log(json);
      for (let data of json) {
        console.log(data);
    ...
    market4.addEventListener("click", async () => {
      ...
      let searchWord = div.innerHTML;
      const result = await fetch(`/marketdata/${searchWord}/4`);
      let json = await result.json();
      console.log(json);
      for (let data of json) {
        console.log(data);
